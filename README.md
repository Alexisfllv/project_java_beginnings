# Proyecto Spring Boot: Arquitectura y Estructura
## Stack Principal
...
![Spring Data JPA](https://img.shields.io/badge/Spring_Data_JPA-3.4.4-6DB33F?style=for-the-badge&logo=spring&logoColor=white)
![MySQL](https://img.shields.io/badge/MySQL-8-4479A1?style=for-the-badge&logo=mysql&logoColor=white)

## Web y API

![Spring Web](https://img.shields.io/badge/Spring_Web-3.4.4-6DB33F?style=for-the-badge&logo=spring&logoColor=white)
![Swagger/OpenAPI](https://img.shields.io/badge/OpenAPI-2.8.6-85EA2D?style=for-the-badge&logo=swagger&logoColor=black)

## Herramientas de Desarrollo

![Lombok](https://img.shields.io/badge/Lombok-Latest-A4A4A4?style=for-the-badge&logo=lombok&logoColor=white)
![MapStruct](https://img.shields.io/badge/MapStruct-1.6.3-BD4043?style=for-the-badge&logo=java&logoColor=white)
![Spring Validation](https://img.shields.io/badge/Bean_Validation-3.4.4-6DB33F?style=for-the-badge&logo=spring&logoColor=white)

## Testing

![Spring Testing](https://img.shields.io/badge/Spring_Test-3.4.4-6DB33F?style=for-the-badge&logo=spring&logoColor=white)
...
<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" width="40" height="40" alt="Java" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #E76F00;">Java 21</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Lenguaje de programación orientado a objetos, fuertemente tipado con soporte para programación funcional.</p>
</div>

<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" width="40" height="40" alt="Spring Boot" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #6DB33F;">Spring Boot 3.4.4</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Framework para el desarrollo de aplicaciones Java que simplifica la configuración y despliegue.</p>
</div>

<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/apache/apache-original.svg" width="40" height="40" alt="Maven" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #C71A36;">Apache Maven</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Herramienta de gestión y construcción de proyectos Java basada en el concepto de POM (Project Object Model).</p>
</div>
...
<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" width="40" height="40" alt="Spring Data JPA" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #6DB33F;">Spring Data JPA</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Framework que facilita la implementación de repositorios basados en JPA, simplificando el acceso a datos.</p>
</div>

<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/mysql/mysql-original.svg" width="40" height="40" alt="MySQL" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #4479A1;">MySQL</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Sistema de gestión de bases de datos relacional de código abierto usado para almacenar y recuperar datos.</p>
</div>
...
<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" width="40" height="40" alt="Spring Web" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #6DB33F;">Spring Web</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Módulo de Spring para el desarrollo de aplicaciones web y RESTful, incluye Spring MVC.</p>
</div>

<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://static1.smartbear.co/swagger/media/assets/swagger_fav.png" width="40" height="40" alt="Swagger" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #85EA2D;">Swagger/OpenAPI</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Framework para diseñar, construir, documentar y consumir APIs RESTful.</p>
</div>
...
<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://avatars.githubusercontent.com/u/45949248?s=48&v=4" width="40" height="40" alt="Lombok" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #A4A4A4;">Lombok</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Biblioteca que reduce el código boilerplate mediante anotaciones (getters, setters, constructores).</p>
</div>

<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://mapstruct.org/images/mapstruct.png" width="40" height="40" alt="MapStruct" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #BD4043;">MapStruct 1.6.3</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Generador de código para mapeos tipo-seguro entre beans Java.</p>
</div>

<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://beanvalidation.org/logo/logo.svg" width="40" height="40" alt="Bean Validation" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #6DB33F;">Bean Validation</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Marco de validación de datos declarativo a través de anotaciones.</p>
</div>
...
<div style="border: 1px solid #ddd; border-radius: 8px; padding: 20px; width: 280px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
  <img src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/spring/spring-original.svg" width="40" height="40" alt="Spring Test" style="float: left; margin-right: 15px;">
  <h3 style="margin: 0 0 10px 0; color: #6DB33F;">Spring Test</h3>
  <p style="margin: 0; clear: both; padding-top: 10px;">Framework para pruebas de integración y unitarias de aplicaciones Spring.</p>
</div>
...
1. **Cliente** → Envía solicitud HTTP al **Controlador**
2. **Controlador** → Recibe la solicitud y la pasa al **Servicio**
3. **Servicio** → Implementa la lógica de negocio, utiliza el **Repositorio**
4. **Repositorio** → Interactúa con la base de datos a través de las **Entidades**
5. **Mappers** → Transforman los datos entre **Entidades** y **DTOs**
6. **Servicio** → Devuelve **DTOs** al **Controlador**
7. **Controlador** → Envía respuesta HTTP al **Cliente**

## Diagrama de Arquitectura

```
┌─────────┐     ┌──────────────┐     ┌────────────┐     ┌────────────┐     ┌──────────┐
│ Cliente │────▶│ Controlador  │────▶│  Servicio  │────▶│Repositorio │────▶│  Base de │
│         │◀────│              │◀────│            │◀────│            │◀────│  Datos   │
└─────────┘     └──────────────┘     └────────────┘     └────────────┘     └──────────┘
                       │                   │                  │
                       │                   │                  │
